...
INSERT INTO PRODUCT_TYPE VALUES('1-2','1','수산');
INSERT INTO PRODUCT_TYPE VALUES('1-3','1','축산');
INSERT INTO MARKET VALUES('ccc','111','동원몰','010-000-0000','00234','서울시 영등포구','234-24번지');
INSERT INTO PRODUCT VALUES(PRODUCT_SEQ.nextval, '우리쌀', '맛좋은 우리쌀', 'noimg.png',null,null, 'aaa');
INSERT INTO PRODUCT_OPTION VALUES(PRODUCT_OPTION_SEQ.nextval,'우리쌀5kg',5000,10000,'1-1',1,5);
INSERT INTO GRADE VALUES('1', '일반회원');
INSERT INTO CUSTOMER VALUES('aaa','111','hong','1','jeenpark@mail.com','010-2017-7619',SYSDATE,'1987-05-24','1',100);
INSERT INTO CUSTOMER VALUES('bbb','111','hong','1','jeenpark@mail.com','010-2017-7619',SYSDATE,'1987-05-24','1',100);
INSERT INTO COUPON VALUES(COUPON_SEQ.nextval, '쿠폰', 10);
INSERT INTO SP_ORDER VALUES(SP_ORDER_SEQ.nextval,'hong','010-2017-7619','11111','부천시오정구','206호',15000,SYSDATE,'배송중','환불신청','aaa');
