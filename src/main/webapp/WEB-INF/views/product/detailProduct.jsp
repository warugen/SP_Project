...
<body>
   <div id="content">
      <div id="content_top">
         <div id="product_img">
            <div class="bigImage">
            <img src="${conPath }/productUpload/${detailProduct.pimage1 }" width="600" height="600" alt="상품이미지">
             <!--   <img
         ...
         <div id="product_info">
            <div id="product_info_headline">
               <p>
                  <a href=""> 입점상점 </a> <span>상품번호 : ${detailProduct.pcode }</span>
               </p>
               <hr>
               <br>
               ...
               <c:forEach var="pq" items="${product_qna }">
                  ...
                  <tr class="qnaReplyContent" id="qnaReplyContent${i }">
                     <td colspan="4">
                        ...
                        </div> <c:if test="${pq.pqanswer != null }">
                           <div style="width: 1000px;">
                              <span> <img src="${conPath }/img/A.PNG" width="35"
                                 height="35">답변
                              </span> ${pq.pqanswer }
                           </div>
                        </c:if> <c:if test="${pq.pqanswer eq null }">
                           <div style="display: none;">
                              <span style="display: none;"> <img
                                 src="${conPath }/img/A.PNG" width="35" height="35">답변
                              </span>
                           </div>
                        </c:if>
                     </td>
