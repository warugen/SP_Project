...
<body>	
	...
	<div id="content">
		...
		<div>
		<form action="${conPath}/myAddressList.do?method=modifyAddr" method="post">
			<input type="hidden" name="cid" value="${addrlist.cid }" />
			<input type="hidden" name="addrcode" value="${addrlist.addrcode }" />
				<h2>회원 주소 수정</h2>
			<table>
				<tr>
					<td>
						<input type="text" id="addrname" name="addrname" value="${addrlist.addrname }" placeholder="배송지이름">
					</td>
				</tr>
				<tr>
					<td>
						<input type="text" id="sample4_postcode" name="cpost" class="postBox" value="${addrlist.cpost }"  placeholder="우편번호">
						<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기" class="btn1">
					</td>
				</tr>
				<tr>
					<td>
						<input type="text" id="sample4_roadAddress" name="caddr1" value="${addrlist.caddr1 }"  placeholder="도로명주소">
						<input type="hidden" id="sample4_jibunAddress" placeholder="지번주소">
						<span id="guide"></span>
					</td>
				</tr>
				<tr>
					<td><input type="text" name="caddr2" value="${addrlist.caddr2 }" placeholder="상세주소를 입력하세요"></td>
				</tr>
			</table>
			<div class="btnwrite">
			<input type="submit" value="주소 수정" class="btn1" />
