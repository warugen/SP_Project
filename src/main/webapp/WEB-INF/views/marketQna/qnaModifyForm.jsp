...
<form action="${conPath }/marketQna.do?method=modify" method="post">
	<input type="hidden" name="pageNum" id="pageNum" value="${param.pageNum }"/>
    <input type="hidden" name="mqcode" id="mqcode" value="${modify.mqcode }"/>
	<div id="main">
	<div align="center">
	...
	<table>
		...
		<tr>
			<th>제목</th>
			<td><input type="text" name="mqtitle" value="${modify.mqtitle }"></td>
		</tr>
		<tr><th>문의 내용 : </th><td colspan="3"><textarea name="mqcontent" id="summernote">${modify.mqcontent }</textarea>
		 <script>
		...
		<tr><td colspan="4">
					<input type="button" value="취소" onclick="location.href='${conPath}/marketQna.do?method=qnaList'" class="btn2">
