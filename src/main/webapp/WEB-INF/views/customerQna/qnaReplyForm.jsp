...
<form action="${conPath }/customerQna.do?method=reply" method="post">
	<input type="hidden" name="pageNum" id="pageNum" value="${param.pageNum }"/>
    <input type="hidden" name="cqcode" id="cqcode" value="${detail.cqcode }"/>
    <input type="hidden" name="cqgroup" id="cqgroup" value="${detail.cqgroup }"/>
    <input type="hidden" name="cqstep" id="cqstep" value="${detail.cqstep }"/>
    <input type="hidden" name="cqindent" id="cqindent" value="${detail.cqindent }"/>
	<div id="main">
	<div align="center">
	...
	<table>
		...
		<tr><th>답변 내용 : </th><td colspan="3"><textarea name="cqcontent" id="summernote"></textarea>
		 <script>
