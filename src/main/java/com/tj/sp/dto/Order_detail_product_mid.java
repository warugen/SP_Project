...
public class Order_detail_product_mid {
	...
	public String toString() {
		return "Order_detail_product_mid [ocode=" + ocode + ", oname=" + oname + ", otel=" + otel + ", opost=" + opost
				+ ", oaddr1=" + oaddr1 + ", oaddr2=" + oaddr2 + ", osum=" + osum + ", odelivery=" + odelivery
				+ ", ostatus=" + ostatus + ", cid=" + cid + ", odcode=" + odcode + ", cuid=" + cuid + ", odcount="
				+ odcount + ", odunit=" + odunit + ", pocode=" + pocode + ", poname=" + poname + ", ponet=" + ponet
				+ ", postock=" + postock + ", poprice=" + poprice + ", typecode=" + typecode + ", pcode=" + pcode
				+ ", mid=" + mid + ", startrow=" + startrow + ", endrow=" + endrow + ", schitem=" + schitem
				+ ", schword=" + schword + "]";
	}
